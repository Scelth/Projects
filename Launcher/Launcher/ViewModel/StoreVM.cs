...
namespace Launcher.ViewModel
{
    class StoreVM : ViewModelBase
    {
        ...
        {
            Info = App.Container.GetInstance(message.VMType) as ViewModelBase;
        }
        ...
        {
            string pathToCategoryFile = $"C:\\Users\\user\\source\\repos\\Admin\\Admin\\bin\\Debug\\net6.0-windows\\{SelectedCategoryName}Category.json";
        ...
        public void Check()
        {
            string pathToCategories = "C:\\Users\\user\\source\\repos\\Admin\\Admin\\bin\\Debug\\net6.0-windows\\Categories.json";
                ...
                try
                {
                    if (name != null)
                    {
                        if (SelectedCategoryName != null)
                        {
                            ...
                            Info = new InfoVM(_messenger, _navigateService, _downloadService, _serializeService)
                            { 
                                Project = project 
                            };
                        }
